...
class _PersonalInfoScreenState extends State<PersonalInfoScreen> {
  ...
  Future<void> _save() async {
    ...
    if (name.length < 2) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(s.authNameShort), backgroundColor: AppColors.error),
      );
      return;
    }
        ...
        child: SafeArea(
          child: ListView(
            ...
            children: [
                    ...
                    children: [
                      ...
                      const Positioned(
                        ...
                        child: CircleAvatar(
                          ...
                          child: Icon(CupertinoIcons.camera_fill, size: 14, color: Colors.white),
                        ),
                      ),
                    ],
                  ),
              ...
              Text(s.fullName, style: const TextStyle(color: AppColors.textMuted, fontSize: 13)),
              ...
              Text(s.email, style: const TextStyle(color: AppColors.textMuted, fontSize: 13)),
              const SizedBox(height: 8),
              _box(
                TextField(
                  readOnly: true,
