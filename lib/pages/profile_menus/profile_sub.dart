...
class _PersonalInfoScreenState extends State<PersonalInfoScreen> {
  ...
  final _emailController = TextEditingController(text: 'aziz.karimov@gmail.com');
              ...
              children: [
                Container(
                  ...
                  child: const CircleAvatar(
                    ...
                    child: Icon(CupertinoIcons.person_fill, size: 44, color: AppColors.primary),
                  ),
                ),
                Positioned(
                  bottom: 0,
...
class _LanguageScreenState extends State<LanguageScreen> {
  ...
  static const List<Map<String, String>> _langs = [
    {'code': 'uz', 'name': "O'zbekcha",  'nativeName': "O'zbek tili",     'flag': '🇺🇿'},
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                const Icon(CupertinoIcons.globe, color: AppColors.primary, size: 20),
...
class _LangTileState extends State<_LangTile> with SingleTickerProviderStateMixin {
