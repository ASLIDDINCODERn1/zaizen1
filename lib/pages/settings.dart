...
class SettingsTab extends StatelessWidget {
  ...
  String _t(BuildContext context, {required String uz, required String ru, required String en, required String ja}) {
    switch (context.read<LocaleProvider>().locale.languageCode) {
      case 'ru':
        return ru;
      case 'en':
        return en;
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        Text(
          _t(context, uz: 'Sozlamalar', ru: 'Настройки', en: 'Settings', ja: '設定'),
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        _t(context, uz: "Ko'rinish", ru: 'Внешний вид', en: 'Appearance', ja: '表示'),
                        style: TextStyle(color: c.textPrimary, fontWeight: FontWeight.w700, fontSize: 14.5),
                      ),
          ...
          child: Column(
            children: [
              _RowItem(
                ...
                onTap: () => Navigator.push(context, CupertinoPageRoute(builder: (_) => const NotificationsScreen())),
              ),
              const _Line(),
              _RowItem(
                icon: CupertinoIcons.lock_shield_fill,
                label: s.security,
                onTap: () => Navigator.push(context, CupertinoPageRoute(builder: (_) => const SecurityScreen())),
              ),
              const _Line(),
              _RowItem(
                icon: CupertinoIcons.globe,
                label: s.language,
                onTap: () => Navigator.push(context, CupertinoPageRoute(builder: (_) => const LanguageScreen())),
              ),
              const _Line(),
              _RowItem(
                icon: CupertinoIcons.question_circle_fill,
                label: s.helpCenter,
                onTap: () => Navigator.push(context, CupertinoPageRoute(builder: (_) => const HelpCenterScreen())),
              ),
            ],
          ),
        ),
