                ...
                child: Row(
                  children: [
                    ...
                    Container(
                      ...
                      child: Icon(CupertinoIcons.sparkles, color: c.primary, size: 18),
                    ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(copy.$1, style: TextStyle(color: c.textPrimary, fontWeight: FontWeight.w700, fontSize: 16)),
                          Text(copy.$2, style: TextStyle(color: c.textMuted, fontSize: 12)),
                        ],
                      ),
                    ),
                    _MicDot(on: _micOn),
                  ...
                  itemBuilder: (context, i) {
                    ...
                    return Align(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: m.mine ? c.primary : c.surface.withValues(alpha: 0.86),
                        ...
                        child: Text(
                          m.text,
                          style: TextStyle(color: m.mine ? Colors.white : c.textPrimary, height: 1.35, fontSize: 15),
                        ),
                      ),
                    );
                  },
                      ...
                      for (final h in hints)
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Text(h, style: TextStyle(color: c.textPrimary, fontSize: 12.5)),
                          ),
                        ),
                    ],
                  ),
                  ...
                  children: [
                    CupertinoButton(
                      ...
                      child: Container(
                        ...
                        child: Icon(
                          _micOn ? CupertinoIcons.mic_fill : CupertinoIcons.mic_slash,
