...
class _RealtimePageState extends State<RealtimePage> with SingleTickerProviderStateMixin {
  bool _micOn = true;
  bool _ready = false;
              ...
              Center(
                child: Column(
                  ...
                  children: [
                    AnimatedBuilder(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: (_micOn ? c.primary : c.surface).withValues(alpha: 0.18),
                          border: Border.all(color: _micOn ? c.primary : c.border, width: 1.4),
                        ),
                        child: Icon(
                          _micOn ? CupertinoIcons.mic_fill : CupertinoIcons.mic_slash_fill,
                    ...
                    Text('Zaizen AI', style: TextStyle(color: c.textPrimary, fontWeight: FontWeight.w700, fontSize: 22)),
                    const SizedBox(height: 6),
                    Text(
                      !_ready ? '...' : (_micOn ? t['on']! : t['off']!),
                      style: TextStyle(color: _micOn ? c.primary : c.textMuted, fontWeight: FontWeight.w600),
                    ),
                    const SizedBox(height: 8),
                    Text(t['hint']!, textAlign: TextAlign.center, style: TextStyle(color: c.textMuted, fontSize: 13)),
                  ],
                ),
              ),
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    _RoundBtn(icon: CupertinoIcons.xmark, onTap: () => Navigator.pop(context)),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(t['live']!, style: TextStyle(color: c.textPrimary, fontWeight: FontWeight.w700, fontSize: 12)),
                        ],
                      ),
                    ),
                    const Spacer(),
                    Column(
                      children: [
                        _RoundBtn(icon: CupertinoIcons.gear_alt_fill, active: true, onTap: () {}),
                        ...
                        Container(
                          ...
                          child: _RoundBtn(
                            icon: _micOn ? CupertinoIcons.mic_fill : CupertinoIcons.mic_slash_fill,
                            active: _micOn,
                            onTap: _toggleMic,
                          ),
                        ),
  ...
  Widget build(BuildContext context) {
    ...
    return CupertinoButton(
      ...
      child: Container(
        ...
        child: Icon(icon, color: active ? Colors.white : c.textPrimary, size: 18),
      ),
    );
  }
}
