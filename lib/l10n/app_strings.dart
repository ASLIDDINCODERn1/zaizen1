/// ─── ILOVANING BARCHA TARJIMALARI ────────────────────────────────────────────
/// Qo'llab-quvvatlanadigan tillar: O'zbekcha (uz), Русский (ru),
///   English (en), 日本語 (ja)
...
class AppStrings {
  ...
  // ── Profil ───────────────────────────────────────────────────────────────────
  String get profileTitle => _t(uz: 'Profil', ru: 'Профиль', en: 'Profile', ja: 'プロフィール');
  ...
  // ── Bottom nav ────────────────────────────────────────────────────────────────
  String get navHomeLabel => _t(uz: 'Bosh sahifa', ru: 'Главная', en: 'Home', ja: 'ホーム');
  String get navRatingLabel => _t(uz: 'Reyting', ru: 'Рейтинг', en: 'Rating', ja: 'ランキング');
  String get navProfileLabel => _t(uz: 'Profil', ru: 'Профиль', en: 'Profile', ja: 'プロフィール');
  ...
  String get leaderboardSub => _t(uz: 'Ushbu hafta eng faol foydalanuvchilar', ru: 'Самые активные пользователи этой недели', en: 'Most active users this week', ja: '今週の最もアクティブなユーザー');
